...
const LoginPage = () => {
  ...
  const formTitle = mode === MODE.LOGIN?"Log in"
        : mode === MODE.REGISTER?"Rgister"
        : mode === MODE.RESET_PASSWORD?"Reset password"
        : "Verify Your Email";
  ...
  return (
    <div className='h-[calc(100vh-80px)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center '>
      ...
      <button className='bg-lama text-white p-2 rounded-md disabled:bg-ping-200 disabled:cursor-not-allowed' disabled={isLoading}>
